...
//サイトのトップページのURL　※デフォルトでは送信完了後に「トップページへ戻る」ボタンが表示されます
$site_top = "http://www.tsumitareinetsu.co.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "kankyou-saitou@tsumitareinetsu.co.jp,keiri2@tsumitareinetsu.co.jp,kaneko@tsumitareinetsu.co.jp";
...
//$thanksPage = "http://www.xxxx.xx";
$thanksPage = $site_top;//36行目で設定するTOPページに戻るようにしています。サンクスページを別にする場合は、この行を削除し、上の行のコメントを外してURLを設定してください。
